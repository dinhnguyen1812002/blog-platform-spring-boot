...
import com.Nguyen.blogplatform.domain.media.dto.AvatarUploadResponse;
...
import com.Nguyen.blogplatform.domain.user.dto.UserProfileResponse;
import com.Nguyen.blogplatform.domain.user.dto.UserProfileUpdateRequest;
import com.Nguyen.blogplatform.domain.user.infrastructure.repository.SocialMediaLinkRepository;
import com.Nguyen.blogplatform.domain.user.infrastructure.repository.UserRepository;
import com.Nguyen.blogplatform.infrastructure.storage.AvatarStorageService;
...
import com.Nguyen.blogplatform.shared.util.SlugUtil;
...
public class UserProfileService {
    ...
    public UserProfileResponse updateUserProfile(String userId, UserProfileUpdateRequest request) throws ConflictException {
        ...
        if (usernameChanged || user.getSlug() == null || user.getSlug().isBlank()) {
            String base = com.Nguyen.blogplatform.shared.util.SlugUtil.toSlug(user.getUsername());
    ...
    public UserProfileResponse updateUserProfileMarkdown(String userId, String markdownContent) {
        ...
        // Get user statistics
        Long postsCount = postRepository.countByAuthor(updatedUser);
    ...
    public PublicProfileResponse getPublicProfileBySlug(String slug) {
        ...
        List<Post> featured = postRepository.findTop5ByAuthorAndFeaturedTrueOrderByCreatedAtDesc(user);
        List<PostSummaryResponse> featuredDtos = postMapper.toPostSummaryList(featured, null, savedPostRepository);
