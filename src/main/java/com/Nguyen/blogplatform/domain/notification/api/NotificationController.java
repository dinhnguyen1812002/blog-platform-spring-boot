package com.Nguyen.blogplatform.domain.notification.api;
...
import com.Nguyen.blogplatform.domain.notification.dto.SendNotificationRequest;
import com.Nguyen.blogplatform.domain.notification.dto.UpdatePreferencesRequest;
import com.Nguyen.blogplatform.domain.notification.dto.UserPreferencesResponse;
...
public class NotificationController {
    ...
    public ResponseEntity<List<com.Nguyen.blogplatform.domain.notification.domain.model.Notifications>> getNotificationsOfUser(
        @AuthenticationPrincipal UserDetailsImpl userDetails) {
