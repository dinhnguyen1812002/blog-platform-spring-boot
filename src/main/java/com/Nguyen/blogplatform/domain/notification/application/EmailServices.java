...
import com.Nguyen.blogplatform.domain.notification.dto.EmailEvent;
...
public class EmailServices {
    ...
    public void queueNewsletterEmail(String to, java.util.List<com.Nguyen.blogplatform.domain.post.domain.model.Post> posts) {
        EmailEvent event = new EmailEvent(
